<!--
* Pilot Equipment
  * Flashlight and batteries, charts, pertinant data readily avialable
* Airplane Equipment & Lighting
  * FLAPS = fuses, landing light (for hire only), anti-collision lights, position lights, source of electricity
  * Position Lights (red stop, green go = right of way rules)
* Airport & Navigation Lighting Aids
  * Rotating Beacon
  * Airport Lighting (AIM 2-1)
    * ALS, VGI, REIL, Runway Edge Lights, In-Runway Lights, Taxiway Lights
  * Pilot Controlled Lighting (How to know it's available, frequency, 3-5-7)
* Night Times
  * Civil Twilight vs. Night
  * Passenger-carrying requirements (3 FULL-STOP TO/Landings in preceding 90 days)
  * Simple Rules
    * Lights = Sunset to Sunrise
    * Logging = End of Civil Twilight to Beginning of Civil Twilight
    * Pax Ops & Currency = 1 Hour After Sunset
* Taxiing/Takeoff
  * Turn on Position, Navigation, Beacon prior to engine start
  * Taxi with Taxi/Take off Light
  * Turn on Strobes only when entering/crossing a runway not to blind landing pilots
* Takeoff/Climb/Cruise
  * Lack of visual references means more attention to flight instruments
  * Clouds will be impossible to see, easy to inadvertently enter IFR
  * If lights begin to take on a halo/glow TURN BACK
  * Crossing large bodies of water can be just as dangerous, no outside references
* Approach/Landing
  * Distance difficult to perceive
  * Maintain airspeeds and emphasis to instruments

* Hearing improves at night-you start hearing things you haven't heard before.
* Know the nighttime definitions
* Perpendicular red lights indicate a runway entrance
* Two white lights on the wing as a tail position light
* Pilot-controlled lighting-how many times do you click
* Alternator/battery test-turn landing light on/off and notice amp rise to check alternator, turn off the alternator to check the battery.
* There is one solenoid in the system that will cause a complete electrical failure - alternator and battery!
...
* Night flying requires special consideration.
  ...
  * Carry at least two flashlights-one for exterior preflight and a smaller one that can be dimmed and kept nearby.
-->
