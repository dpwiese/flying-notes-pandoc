...
Important to understand navigation skills with various types of equipment and lost procedures.

* Primary means of navigation = dead reckoning + radio / GPS
* Remember: calculations are estimates based on forecast conditions, should be updated in-flight
* Look for all resources available (VOR, GPS direct-to, GPS nearest)
-->
...
![Magnetic variation and agonic line.](./img/phak/phak-figure-16-9-agonic-lines.png){width=3.4in}
...
![Sectional legend.](./img/sectional-legend-2.jpg){width=4in}

![Washington Baltimore flyway chart.](./img/washington-baltimore-flyway-chart.jpg){width=5in}
...
![Maximum Elevation Figure.](./img/mef_example.jpg){width=3.4in}
...
![Altitudes.](./img/altitudes.png){width=4in}

# 3. Proper and Current Charts
