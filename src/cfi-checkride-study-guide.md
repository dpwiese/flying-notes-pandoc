...
<!--
    * Also for the instructor, it helps them understand how the student is progressing, and how teaching methods are working
    * Primary assessment of CFI will be authentic (performance of real world tasks) and HOTS
    * An effective critique should be
        ...
        * Thoughtful
        * Specific
    * Good types of questions to use for assessment
        * Apply to the subject at hand
        * Brief and concise
        * Complexity is compatible with the stage in training
        * Center on one idea
        * Make it challenging
    * Several types of critique
...
![Medical [14 CFR &sect;61.23(d)](https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-A/section-61.23#p-61.23(d))](./img/medical-certificate-requirements-table.png){width=6in}
...
![Airspace communication requirements and weather minimums. Reference unknown.](./img/airspace-at-a-glance.jpg){width=6.25in}
-->
